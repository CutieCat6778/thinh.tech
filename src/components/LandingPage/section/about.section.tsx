...
export function AboutBox() {
    return (
        <Flex justifyContent={"space-around"}
            ...
            <Image src="https://cutiecat6778.github.io/cdn/portfolio/about.webp"
                width={{ base: "350px", "lg": "400px", "xl": "600px" }}
                height={{ base: "230px", "lg": "290px", "xl": "430px" }}
                alt="Profile picture"
                borderRadius={"3%"}
                boxShadow="2xl" />
        </Flex>
