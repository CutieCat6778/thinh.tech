export default function SkillTable({ font, font2 }: any) {
  return (
    <>
      <div className={font + " flex lg:w-auto md:w-144 w-96"}>
              ...
              <table className="min-w-full">
                ...
                <tbody>
                  <tr className="border-b">
                    <td className={font2 + " text-md text-gray-900 font-bold px-6 py-4 whitespace-nowrap color-purple"}>
                      Javascript
                    </td>
